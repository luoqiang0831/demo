...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
        ...
        , F = I("div"), E = I("img"), Y = a._internals = {
            _specialProps: l
            ...
            c = p && 6 > Number(B.substr(B.indexOf("Version/") + 8, 1)),
            _ = -1 !== B.indexOf("Firefox"),
        ...
        , G = a.getStyle = function(t, e, i, r, s) {
            var n;
            return U || "opacity" !== e ? (!r && t.style[e] ? n = t.style[e] : (i = i || Q(t)) ? n = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(S, "-$1").toLowerCase()) : t.currentStyle && (n = t.currentStyle[e]),
            null  == s || n && "none" !== n && "auto" !== n && "auto auto" !== n ? n : s) : j(t)
        }
        ...
        , K = function(t, e) {
            ...
            if (e = e || Q(t, null ))
                if (i = e.length)
                    for (; --i > -1; )
                        s[e[i].replace(C, k)] = e.getPropertyValue(e[i]);
                else
                    for (i in e)
                        s[i] = e[i];
            else if (e = t.currentStyle || t.style)
                for (i in e)
                    "string" == typeof i && void 0 === s[i] && (s[i.replace(C, k)] = e[i]);
            return U || (s.opacity = j(t)),
            r = Me(t, e, !1),
        ...
        , te = {
            ...
            for (i = i || Q(t, null ); --n > -1; )
                r -= parseFloat(G(t, "padding" + s[n], i, !0)) || 0,
                r -= parseFloat(G(t, "border" + s[n] + "Width", i, !0)) || 0;
            return r
        }
        , re = function(t, e) {
        ...
        , ae = function(t, e, i, r) {
            ...
            n = t.split("_"),
            a = Number(n[0].replace(y, "")) * (-1 === t.indexOf("rad") ? 1 : N) - ("=" === t.charAt(1) ? 0 : e),
            n.length && (r && (r[i] = e + a),
        ...
        Y.CSSPropTween = function(t, e, r, s, a, o, l, h, u, f, p) {
          ...
          , de = a.parseComplex = function(t, e, i, r, s, n, a, o, l, h) {
            ...
            f = 0; k > f; f++)
                ...
                x = parseFloat(c),
                x || 0 === x)
                    a.appendXtra("", x, se(d, x), d.replace(g, ""), O && -1 !== d.indexOf("px"), !0);
                else if (s && ("#" === c.charAt(0) || oe[c] || P.test(c)))
                    S = "," === d.charAt(d.length - 1) ? ")," : ")",
                    c = he(c),
                    d = he(d),
                    T = c.length + d.length > 6,
                    T && !U && 0 === d[3] ? (a["xs" + a.l] += a.l ? " transparent" : "transparent",
                    a.e = a.e.split(R[f]).join("transparent")) : (U || (T = !1),
                    a.appendXtra(T ? "rgba(" : "rgb(", c[0], d[0] - c[0], ",", !0, !0).appendXtra("", c[1], d[1] - c[1], ",", !0).appendXtra("", c[2], d[2] - c[2], T ? "," : S, !0),
                    T && (c = 4 > c.length ? 1 : c[3],
                    a.appendXtra("", c, (4 > d.length ? 1 : d[3]) - c, S, !1)));
                else if (v = c.match(m)) {
                    if (y = d.match(g),
                    !y || y.length !== v.length)
                        return a;
                    ...
                    p = 0; v.length > p; p++)
                        b = v[p],
                        w = c.indexOf(b, _),
                        a.appendXtra(c.substr(_, w - _), Number(b), se(y[p], b), "", O && "px" === c.substr(w + b.length, 2), 0 === p),
                        _ = w + b.length;
                    a["xs" + a.l] += c.substr(_)
                } else
                    a["xs" + a.l] += a.l ? " " + c : c;
        ...
        h.appendXtra = function(t, e, i, r, s, n) {
            ...
            a.rxp["xn" + o] = s,
            a["xn" + o] = e,
            a.plugin || (a.xfirst = new ce(a,"xn" + o,e,i,a.xfirst || a,0,a.n,s,a.pr),
            a.xfirst.xs0 = 0),
            a) : (a.data = {
                s: e + i
            },
            ...
            if (!l[t]) {
                ...
                ve(t, {
                    parser: function(t, i, r, s, n, a, h) {
                        ...
                        l[r].parse(t, i, r, s, n, a, h)) : (W("Error: " + e + " js file not loaded."),
                        n)
                    }
                })
            }
        ...
        , Oe = document.documentElement, Ae = function() {
            ...
            return X.createElementNS && !r && (t = ke("svg", Oe),
            e = ke("rect", t, {
                width: 100,
                height: 50,
                x: 100
            ...
            r = i === e.getBoundingClientRect().width,
            Oe.removeChild(t)),
            r
        }(), De = function(t, e, i) {
            var r = t.getBBox();
        ...
        , Me = Y.getTransform = function(t, e, i, r) {
            ...
            if (we ? o = G(t, be, e, !0) : t.currentStyle && (o = t.currentStyle.filter.match(A),
            ...
            m.svg = !!(Re && "function" == typeof t.getBBox && t.getCTM && (!t.parentNode || t.parentNode.getBBox && t.parentNode.getCTM)),
            m.svg && (De(t, G(t, Pe, s, !1, "50% 50%") + "", m),
            xe = a.useSVGTransformAttr || Ae,
            l = t.getAttribute("transform"),
            n && l && -1 !== l.indexOf("matrix") && (o = l,
            n = 0)),
            !n) {
                for (l = (o || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [],
                h = l.length; --h > -1; )
                    u = Number(l[h]),
                    l[h] = (f = u - (u |= 0)) ? (0 | f * y + (0 > f ? -.5 : .5)) / y + u : u;
                if (16 === l.length) {
                    var w = l[8]
                      , b = l[9]
                      , P = l[10]
                      ...
                      , C = l[13]
                      , R = l[14];
                    m.zOrigin && (R = -m.zOrigin,
                    S = w * R - l[12],
                    C = b * R - l[13],
                    R = P * R + m.zOrigin - l[14]);
                    ...
                    Y = O,
                    B = D),
                    m.scaleX = (0 | Math.sqrt(z * z + X * X) * y + .5) / y,
                    m.scaleY = (0 | Math.sqrt(Y * Y + b * b) * y + .5) / y,
                    m.scaleZ = (0 | Math.sqrt(B * B + P * P) * y + .5) / y,
                    m.skewX = 0,
                    ...
                    p = Math.sqrt(q * q + H * H),
                    _ = Math.sqrt(Z * Z + Q * Q),
                    c = q || H ? Math.atan2(H, q) * N : m.rotation || 0,
                    d = Q || Z ? Math.atan2(Q, Z) * N + c : m.skewX || 0,
                    Math.abs(d) > 90 && 270 > Math.abs(d) && (g ? (p *= -1,
                    d += 0 >= c ? 180 : -180,
                    c += 0 >= c ? 180 : -180) : (_ *= -1,
                    d += 0 >= d ? 180 : -180)),
                    m.scaleX = p,
                    ...
                    m.rotation = c,
                    m.skewX = d,
                    Se && (m.rotationX = m.rotationY = m.z = 0,
                    m.perspective = T,
                    m.scaleZ = 1)
                }
                m.zOrigin = x;
        ...
        , Le = function(t) {
            ...
            if (p) {
                ...
                c = (r.oyp ? .01 * g * r.oy : r.oy) - g / 2,
                w += _ - (_ * o + c * l),
                b += c - (_ * h + c * u)),
                v ? (_ = m / 2,
                c = g / 2,
                y += ", Dx=" + (_ - (_ * o + c * l) + w) + ", Dy=" + (c - (_ * h + c * u) + b) + ")") : y += ", sizingMethod='auto expand')",
                f.filter = -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? e.replace(D, y) : y + " " + e,
                ...
                !v) {
                    ...
                    me = 0; 4 > me; me++)
                        ...
                        C = i !== r[S] ? 2 > me ? -r.ieOffsetX : -r.ieOffsetY : 2 > me ? _ - r.ieOffsetX : c - r.ieOffsetY,
                        f[S] = (r[S] = Math.round(i - C * (0 === me || 2 === me ? 1 : R))) + "px"
                }
            }
        }
        , Ne = Y.set3DTransformRatio = function(t) {
            ...
            if (!(1 !== t && 0 !== t || "auto" !== R.force3D || R.rotationY || R.rotationX || 1 !== M || I || X))
            ...
            if (_) {
                ...
                F > A && A > -F && (A = M = 2e-5),
                F > D && D > -F && (D = M = 2e-5),
                !I || R.z || R.rotationX || R.rotationY || (I = 0)
            }
            if (O || R.skewX)
                y = Math.cos(O),
                x = Math.sin(O),
                ...
                y = Math.cos(O),
                x = Math.sin(O),
                "simple" === R.skewType && (T = Math.tan(R.skewX * L),
                T = Math.sqrt(1 + T * T),
                y *= T,
                x *= T)),
                i = -x,
                ...
                if (!(R.rotationY || R.rotationX || 1 !== M || I || R.svg))
                    return k[we] = (R.xPercent || R.yPercent ? "translate(" + R.xPercent + "%," + R.yPercent + "%) translate3d(" : "translate3d(") + N + "px," + z + "px," + X + "px)" + (1 !== A || 1 !== D ? " scale(" + A + "," + D + ")" : ""),
                    void 0;
                e = a = 1,
                i = n = 0
            }
            ...
            l = o * p,
            p = f * p + g),
            R.svg && (s += R.xOrigin - (R.xOrigin * e + R.yOrigin * i),
            l += R.yOrigin - (R.xOrigin * n + R.yOrigin * a)),
            s = (T = (s += N) - (s |= 0)) ? (0 | T * v + (0 > T ? -.5 : .5)) / v + s : s,
            l = (T = (l += z) - (l |= 0)) ? (0 | T * v + (0 > T ? -.5 : .5)) / v + l : l,
            p = (T = (p += X) - (p |= 0)) ? (0 | T * v + (0 > T ? -.5 : .5)) / v + p : p,
            S = R.xPercent || R.yPercent ? "translate(" + R.xPercent + "%," + R.yPercent + "%) matrix3d(" : "matrix3d(",
            S += (0 | e * v) / v + C + (0 | n * v) / v + C + (0 | h * v) / v,
            S += C + (0 | c * v) / v + C + (0 | i * v) / v + C + (0 | a * v) / v,
            S += C + (0 | u * v) / v + C + (0 | d * v) / v + C + (0 | r * v) / v,
            S += C + (0 | o * v) / v + C + (0 | f * v) / v + C + (0 | m * v) / v,
            S += C + s + C + l + C + p + C + (I ? 1 + -p / I : 1) + ")",
            k[we] = S
        }
        , ze = Y.set2DTransformRatio = function(t) {
            var e, i, r, s, n, a, o, l, h, u, f, p = this.data, _ = this.t, c = _.style, d = p.x, m = p.y;
            return !(p.rotationX || p.rotationY || p.z || p.force3D === !0 || "auto" === p.force3D && 1 !== t && 0 !== t) || p.svg && xe || !Se ? (s = p.scaleX,
            n = p.scaleY,
            p.rotation || p.skewX || p.svg ? (e = p.rotation * L,
            i = e - p.skewX * L,
            r = 1e5,
            a = Math.cos(e) * s,
            o = Math.sin(e) * s,
            ...
            p.svg && xe ? _.setAttribute("transform", "matrix(" + u) : c[we] = (p.xPercent || p.yPercent ? "translate(" + p.xPercent + "%," + p.yPercent + "%) matrix(" : "matrix(") + u) : c[we] = (p.xPercent || p.yPercent ? "translate(" + p.xPercent + "%," + p.yPercent + "%) matrix(" : "matrix(") + s + ",0,0," + n + "," + d + "," + m + ")",
            void 0) : (this.setRatio = Ne,
            Ne.call(this, t),
            void 0)
        }
        ;
        ...
        ve("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
            parser: function(t, e, i, r, n, o, l) {
                ...
                if ("string" == typeof x.transform && we)
                    ...
                    h.xPercent = ne(x.x, m.xPercent)),
                    "string" == typeof x.y && -1 !== x.y.indexOf("%") && (h.y = 0,
                    h.yPercent = ne(x.y, m.yPercent)),
                    h.rotation = ae("rotation" in x ? x.rotation : "shortRotation" in x ? x.shortRotation + "_short" : "rotationZ" in x ? x.rotationZ : m.rotation, m.rotation, "rotation", T),
                    Se && (h.rotationX = ae("rotationX" in x ? x.rotationX : "shortRotationX" in x ? x.shortRotationX + "_short" : m.rotationX || 0, m.rotationX, "rotationX", T),
                    h.rotationY = ae("rotationY" in x ? x.rotationY : "shortRotationY" in x ? x.shortRotationY + "_short" : m.rotationY || 0, m.rotationY, "rotationY", T)),
                ...
                for (Se && null  != x.force3D && (m.force3D = x.force3D,
                c = !0),
                ...
                _ || null  == x.scale || (h.scaleZ = 1); --y > -1; )
                    i = Te[y],
                    p = h[i] - m[i],
                    (p > v || -v > p || null  != x[i] || null  != z[i]) && (c = !0,
                    n = new ce(m,i,m[i],p,n),
                    i in T && (n.e = T[i]),
                    n.xs0 = 0,
                    n.plugin = o,
                ...
                p && m.svg && (De(t, p, h),
                n = new ce(m,"xOrigin",m.xOrigin,h.xOrigin - m.xOrigin,n,-1,"transformOrigin"),
                n.b = m.xOrigin,
                n.e = n.xs0 = h.xOrigin,
                n = new ce(m,"yOrigin",m.yOrigin,h.yOrigin - m.yOrigin,n,-1,"transformOrigin"),
                n.b = m.yOrigin,
                n.e = n.xs0 = h.yOrigin,
                p = "0px 0px"),
                (p || Se && _ && m.zOrigin) && (we ? (c = !0,
                i = Pe,
                p = (p || G(t, i, s, !1, "50% 50%")) + "",
                ...
                n = new ce(m,"zOrigin",0,0,n,-1,n.n),
                n.b = f,
                n.xs0 = n.e = m.zOrigin) : n.xs0 = n.e = p) : re(p + "", m)),
                c && (r._transformType = m.svg && xe || !_ && 3 !== this._transformType ? 2 : 3),
                n
            },
            prefix: !0
        }),
        ...
        ve("borderRadius", {
            ...
            parser: function(t, e, i, n, a) {
                ...
                o = e.split(" "),
                l = 0; b.length > l; l++)
                    this.p.indexOf("border") && (b[l] = H(b[l])),
                    f = u = G(t, b[l], s, !1, "0px"),
        ...
        ve("backgroundPosition", {
            ...
            parser: function(t, e, i, r, n, a) {
                ...
                if (-1 !== m.indexOf("%") != (-1 !== g.indexOf("%")) && (p = G(t, "backgroundImage").replace(R, ""),
                p && "none" !== p)) {
                    for (o = m.split(" "),
                    l = g.split(" "),
                    ...
                    h = 2; --h > -1; )
                        m = o[h],
                        u = -1 !== m.indexOf("%"),
                        u !== (-1 !== l[h].indexOf("%")) && (f = 0 === h ? t.offsetWidth - E.width : t.offsetHeight - E.height,
        ...
        ve("clip", {
            ...
            parser: function(t, e, i, r, n, a) {
                ...
                e = this.format(e).split(",").join(h)) : (o = this.format(G(t, this.p, s, !1, this.dflt)),
                e = this.format(e)),
        ...
        var Xe = function(t) {
            ...
            e = !G(this.data, "filter")) : (i.filter = r.replace(b, ""),
            e = !0)),
        ...
        ve("opacity,alpha,autoAlpha", {
            ...
            parser: function(t, e, i, r, n, a) {
                ...
                h && 1 === o && "hidden" === G(t, "visibility", s) && 0 !== e && (o = 0),
                U ? n = new ce(l,"opacity",o,e - o,n) : (n = new ce(l,"opacity",100 * o,100 * (e - o),n),
                n.xn1 = h ? 1 : 0,
                l.zoom = 1,
                n.type = 2,
                ...
                n.plugin = a,
                n.setRatio = Xe),
                h && (n = new ce(l,"visibility",0,0,n,-1,null ,!1,0,0 !== o ? "inherit" : "hidden",0 === e ? "hidden" : "inherit"),
                n.xs0 = "inherit",
                r._overwriteProps.push(n.n),
        ...
        ve("className", {
            parser: function(t, e, r, n, a, o, l) {
                ...
                if (a = n._classNamePT = new ce(t,r,0,0,a,2),
                a.setRatio = Fe,
                a.pr = -11,
                i = !0,
                a.b = c,
        ...
        h._onInitTween = function(t, e, o) {
            ...
            if (f && "" === T.zIndex && (l = G(t, "zIndex", s),
            ("auto" === l || "" === l) && this._addLazySet(T, "zIndex", 0)),
            "string" == typeof e && (d = T.cssText,
            l = K(t, s),
            T.cssText = d + ";" + e,
            l = J(t, l, K(t)).difs,
            ...
            this._transformType) {
                ...
                we ? p && (f = !0,
                "" === T.zIndex && (v = G(t, "zIndex", s),
                ("auto" === v || "" === v) && this._addLazySet(T, "zIndex", 0)),
                c && this._addLazySet(T, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (x ? "visible" : "hidden"))) : T.zoom = 1,
                _ = h; _ && _._next; )
                    _ = _._next;
                y = new ce(t,"transform",0,0,null ,2),
                this._linkCSSP(y, null , _),
                y.setRatio = x && Se ? Ne : we ? ze : Le,
            ...
            if (i) {
                for (; h; ) {
                    ...
                    _ = d; _ && _.pr > h.pr; )
                        _ = _._next;
                    (h._prev = _ ? _._prev : m) ? h._prev._next = h : d = h,
                    (h._next = _) ? _._prev = h : m = h,
                    h = g
                }
                this._firstPT = d
            }
        ...
        h.parse = function(t, e, i, n) {
            ...
            for (a in e)
                _ = e[a],
                o = l[a],
                o ? i = o.parse(t, _, a, this, i, n, e) : (p = G(t, a, s) + "",
                m = "string" == typeof _,
                "color" === a || "fill" === a || "stroke" === a || -1 !== a.indexOf("Color") || m && P.test(_) ? (m || (_ = he(_),
                _ = (_.length > 3 ? "rgba(" : "rgb(") + _.join(",") + ")"),
                i = de(v, a, p, _, !0, "transparent", i, 0, n)) : !m || -1 === _.indexOf(" ") && -1 === _.indexOf(",") ? (h = parseFloat(p),
                c = h || 0 === h ? p.substr((h + "").length) : "",
                ("" === p || "auto" === p) && ("width" === a || "height" === a ? (h = ie(t, a, s),
                c = "px") : "left" === a || "top" === a ? (h = $(t, a, s),
                ...
                c !== d && "" !== d && (f || 0 === f) && h && (h = Z(t, a, h, c),
                "%" === d ? (h /= Z(t, a, 100, "%") / 100,
                e.strictUnits !== !0 && (p = h + "%")) : "em" === d ? h /= Z(t, a, 1, "em") : "px" !== d && (f = Z(t, a, f, d),
                d = "px"),
                g && (f || 0 === f) && (_ = f + h + d)),
                g && (f += h),
                !h && 0 !== h || !f && 0 !== f ? void 0 !== v[a] && (_ || "NaN" != _ + "" && null  != _) ? (i = new ce(v,a,f || h || 0,0,i,-1,a,!1,0,p,_),
                i.xs0 = "none" !== _ || "display" !== a && -1 === a.indexOf("Style") ? _ : p) : W("invalid " + a + " tween value: " + e[a]) : (i = new ce(v,a,h,f - h,i,0,a,u !== !1 && ("px" === d || "zIndex" === a),0,p,_),
                i.xs0 = d)) : i = de(v, a, p, _, !0, null , i, 0, n)),
        ...
        var Be = function(t, e, i) {
            ...
            if (t.slice)
                ...
                s = r.length; --s > -1; )
                    ...
                    n.style && (e.push(K(n)),
                    i && i.push(n)),
                    1 !== a && 9 !== a && 11 !== a || !n.childNodes.length || Be(n, e, i)
        }
        ;
